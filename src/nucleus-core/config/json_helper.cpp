...
namespace config {
    ...
    void TlogLine::serialize(data::Environment &environment, rapidjson::Writer<rapidjson::StringBuffer> &writer) {
        writer.StartObject();
    ...
    void JsonHelper::serialize(data::Environment &environment, rapidjson::Writer<rapidjson::StringBuffer> &writer,
        ...
        switch (value.getType()) {
            ...
            case data::ValueTypes::CONTAINER:
                if (value.isType<data::ListModelBase>()) {
                    std::shared_ptr<data::ListModelBase> list = value.castContainer<data::ListModelBase>()->copy();
                    ...
                    std::shared_ptr<data::StructModelBase> s = value.castContainer<data::StructModelBase>()->copy();
